package com.github.chengbin.crawler.constant;
...
public class LotteryConstants {
     ...
     * 彩种销售终端
     */
    public static final String SALE_END_WEB = "WEB";
    public static final String SALE_END_ADROID = "ANDROID";
    public static final String SALE_END_IOS = "IOS";
    public static final String SALE_END_H = "H5";
